namespace tasarımsüreçleri
{
	partial class Form5
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Location = new System.Drawing.Point(565, 422);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(83, 13);
			this.label2.TabIndex = 9;
			this.label2.Text = "Doluluk Durumu";
			// 
			// label1
			// 
			this.label1.AutoSize = true;
			this.label1.Location = new System.Drawing.Point(222, 422);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(91, 13);
			this.label1.TabIndex = 8;
			this.label1.Text = "Otopark Kamerası";
			// 
			// button2
			// 
			this.button2.Image = global::tasarımsüreçleri.Properties.Resources.park2;
